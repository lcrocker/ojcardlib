...
oj_cardlist_t _oj_common_decks[] = {
    ...
    { 0x10ACE0FF, 32, 32, OJF_RDONLY, 0, 0LL, _stripped32_cards },
    { 0x10ACE0FF, 40, 40, OJF_RDONLY, 0, 0LL, _stripped40_cards },
    { 0x10ACE0FF, 41, 41, OJF_RDONLY, 0, 0LL, _stripped40j_cards },
